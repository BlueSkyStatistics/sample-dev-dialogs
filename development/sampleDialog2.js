...
var localization = {
    en: {
        ...
        inputControl2: "Enter a label for the textbox",
...
class sampleDialog2 extends baseModal {
    constructor() {
        var config = {
            id: "sampleDialog2",
...
print("The contents of the input control: {{selected.inputControl | safe}}")
print("The contents of the 2nd input control: {{selected.inputControl2 | safe}}")
`
        };
...
//the input control is a textbox control
 ...
 //The dstVariable control is a variable list control
            ...
            inputControl2: {
                el: new input(config, {
                    no: 'inputControl2',
                    label: localization.en.inputControl2,
                    placeholder: "",
                    required: true,
                    type: "character",
                    extraction: "TextAsIs",
        ...
        const content = {
            ...
            head: [objects.inputControl.el.content],
            ...
            right: [objects.independent.el.content],
            bottom: [objects.inputControl2.el.content],
            nav: {
...
module.exports.item = new sampleDialog2().render()